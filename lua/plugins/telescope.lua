return {
    ...
    keys = {
        ...
        { '<leader>fd', function() require('telescope.builtin').diagnostics() end, { desc = "[f]ind [d]iagnostic" } },
        ...
        { '<leader>f.', function() require('telescope.builtin').oldfiles() end,    { desc = "[f]ind recent file ([.] for repeat)" } },
        { '<C-p>',      function() require('telescope.builtin').git_files() end,   { desc = "[f]ind in [g]it" } },
    }
}
